...
import kotlinx.android.synthetic.main.item_intake.view.*

class UniversityResultIntakeRecyclerViewAdapter(val context: Context?, var intakeList: ArrayList<Intake>, val clickListener: (String) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): RecyclerView.ViewHolder {

        return MyViewHolder(
            LayoutInflater.from(context).inflate(R.layout.item_intake, parent, false)
        )
    }
    ...
    class MyViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(intk: Intake) {
            ...
            val passFail = itemView.intake_pass_fail
            val progress = itemView.position

            intakeTitle.text = intk.intake_Title
            totalStudent.text = "Total Students: ${intk.totalStudents}"
            passFail.text = "Pass: ${intk.totalPass}  Fail: ${intk.totalFail}"
            progress.text = calculatePercentage(intk.totalStudents.toDouble(),intk.totalPass.toDouble())

            if(intk.semesterName == "First Semester" || intk.semesterName == "1st Semester"){
            ...
            }else if(intk.semesterName == "Second Semester" || intk.semesterName == "2nd Semester"){
            ...
            }else if(intk.semesterName == "Third Semester" || intk.semesterName == "3rd Semester"){
            ...
            }else if(intk.semesterName == "Fourth Semester" || intk.semesterName == "4th Semester"){
            ...
            }else if(intk.semesterName == "Fifth Semester" || intk.semesterName == "5th Semester"){
            ...
            }else if(intk.semesterName == "Sixth Semester" || intk.semesterName == "6th Semester"){
            ...
            }else if(intk.semesterName == "Seventh Semester" || intk.semesterName == "7th Semester"){
            ...
            }else if(intk.semesterName == "Eighth Semester" || intk.semesterName == "8th Semester"){
            ...
            }else if(intk.semesterName == "Ninth Semester" || intk.semesterName == "9th Semester"){
            ...
            }else if(intk.semesterName == "Tenth Semester" || intk.semesterName == "10th Semester"){
            ...
            }else if(intk.semesterName == "Eleventh Semester" || intk.semesterName == "11th Semester"){
            ...
            }else if(intk.semesterName == "Twelfth Semester" || intk.semesterName == "12th Semester"){
        ...
        private fun calculatePercentage(tStudent:Double, tPass:Double):String{
            return "${(((tPass/tStudent))*100).toInt()}%"
        }
    }
}
