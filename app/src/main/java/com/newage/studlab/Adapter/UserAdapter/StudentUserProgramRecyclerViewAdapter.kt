...
class StudentUserProgramRecyclerViewAdapter(val context: Context?, var progList: ArrayList<Program>, val clickListener: (String) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class MyViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(prog: Program) {
            ...
            progUsersCount.text = "Student: ${prog.studentNumber}"
