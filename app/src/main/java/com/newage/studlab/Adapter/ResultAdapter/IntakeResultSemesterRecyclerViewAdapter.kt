...
class IntakeResultSemesterRecyclerViewAdapter(val context: Context?, var intakeList: ArrayList<Intake>, val clickListener: (String) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemClick.setOnClickListener {
            clickListener(intakeList[position].semesterName)
        }
