...
import com.newage.studlab.Home.ResultFragment.UniversityIntakeFragment.Companion.newResultList
...
class UniversityResultFragment : Fragment(), OnBarClickedListener {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_university_result, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(UniversityResultProgramFragment.intakeList.isNotEmpty()){
    ...
    private fun allButtonClickingEventListeners(){
        backButton.setOnClickListener{
            ...
            transaction.replace(R.id.main_home_fragment_container, UniversityIntakeFragment())
            transaction.commit()
        }
    }
    ...
    private fun filter(text: String) {
        ...
        for (item in newResultList) {
            if (StudLabAssistant.pointToGrade(item.Student_Cgpa).toLowerCase().contains(text.toLowerCase())
    ...
    private fun userProfileClickListener(res:Results){
